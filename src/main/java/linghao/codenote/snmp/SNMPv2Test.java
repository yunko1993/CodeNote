...
public class SNMPv2Test {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        target.setAddress(new UdpAddress("111.231.249.224/161"));
        target.setTimeout(1000);	//3s
        target.setRetries(1);
        ...
        broadcastTarget.setAddress(new UdpAddress("111.231.249.224/161"));
...
//    private static  PDU createDiskPdu(){
//
//    }
